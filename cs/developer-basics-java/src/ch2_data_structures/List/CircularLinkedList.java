...
public class CircularLinkedList {
    ...
    public static void main(String[] args) {
        CircularLinkedList testList = new CircularLinkedList();
        ...
        System.out.println(testList.toOverviewString());
        assert ("[addFirst, 0, 2, ASDJ, DFJE] size=5 length=5").equals(testList.toOverviewString());
        ...
        assert ("[addFirst, addAtIndex1, setIndex1, 2, DFJE] size=5 length=5").equals(testList.toOverviewString());

        System.out.println(testList.toStringForwardTwice());
        assert ("TO ARRAY-STRING FORWARD TWICE: [addFirst>>addAtIndex1>>setIndex1>>2>>DFJE>>addFirst>>addAtIndex1>>setIndex1>>2>>DFJE]").equals(testList.toStringForwardTwice());
        System.out.println(testList.toStringBackwardTwice());
        assert ("TO ARRAY-STRING BACKWARD TWICE: [DFJE<<2<<setIndex1<<addAtIndex1<<addFirst<<DFJE<<2<<setIndex1<<addAtIndex1<<addFirst]").equals(testList.toStringBackwardTwice());
