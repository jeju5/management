...
public class DoublyLinkedList implements List{
    ...
    public static void main(String[] args) {
        ...
        assert ("TO ARRAY-STRING FORWARD: [addFirst>>addAtIndex1>>setIndex1>>2>>DFJE]").equals(testList.toStringForward());
        System.out.println(testList.toStringBackward());
        assert ("TO ARRAY-STRING BACKWARD: [DFJE<<2<<setIndex1<<addAtIndex1<<addFirst]").equals(testList.toStringBackward());
