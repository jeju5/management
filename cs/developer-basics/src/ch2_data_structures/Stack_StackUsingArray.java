...
public class Stack_StackUsingArray implements Stack {
    ...
    public static void main(String[] args) {
        Stack testStack = new Stack_StackUsingArray();

        testStack.push("enqueue0");
        testStack.push("enqueue1");
        testStack.push("enqueue2");
        System.out.println(testStack.toOverviewString());
        assertEquals("[enqueue0, enqueue1, enqueue2]<->IN/OUT size=3 length=4", testStack.toOverviewString());
