...
```
대화
1. "긍정적 이성적 미래적인 / 내 이야기를 / 낮고 적게한다." (말할때)
2. "어, 그래, 진짜를 활용한다."         (들을때)
...
- 레버리지
   - 미국
      - 버핏지수가 100% 이하인 순간부터 3X 레버리지 TQQQ ETF매수를 고려한다. 매수한 ETF는 들고간다. (올인은 하지마라)
   - 중국
      - 버핏지수가 30% 이하인 순간부터 3X 레버리지 YINN ETF매수를 고려한다. 매수한 ETF는 2년내에 매도한다.
