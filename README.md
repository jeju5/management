# TIME
  ```
     TIME     TASK
  ------------------------
  0430 0530  기상 운동       # 0500 블루케일, 허니몬드, 보충(pill)
  0530 0600  예배           
  ------------------------
  0600 0800  훈련  (2.0H)   # 1100 물일리터
  0800 1200  일과  (4.0H)   # 1200 샌드위치                     *빵세장, 사우어크라우트, 꿀, 피넛버터, 계란
  1200 0400  일과  (4.0H)   
  0400 0600  자유  (2.0H)   # 0500 블루케일, 타코, 보충제(powder)  *토티아-세장, 버터, 갈릭, 양파, 치킨
  0600 0800  자유  (2.0H)   
  ------------------------
  0800 0820  성경
  0820 0830  정리 취침
