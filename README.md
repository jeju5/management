# DAY
  ```
     TIME     TASK
  ------------------------
  0400 0530  운동            # 아침: 블루콜리 + 영양보충
  0530 0630  예배
  0630 0800  공부
  ------------------------ 
  0630 0800  공부  (1.5H)    # 점심: 물일리터 + 바나나
  0800 0400  일과  (8.0H)    
  0400 0700  자유  (3.0H)    # 저녁: 블루콜리 + 타코 (쉘2 + 고기, 마늘, 양파, 사우어크라우트)
  ------------------------
  0700 0820  성경           
  0820 0830  정리 취침
  ------------------------
...
# MOVE
  ...
  -----------------------------------------------------------------------------------------
  |  휴식    | PULL(50)    DIPS(50)    | CURL(200)   PUSH(200)   | PULL(50)    DIPS(50)    |
  |         | SIT(300)    SQUAT(500)  | SIT(300)    SQUAT(500)  | SIT(300)    SQUAT(500)  |
  -----------------------------------------------------------------------------------------
  ```
