# MOVE
  ...
  -------------------------------------------------------------------------------------------
  |  COOK   | PULL(70)     RDIP(70)     CALF(500)   | PULL(70)     RDIP(70)     CALF(500)   |
  |         | CURL(140)    PUSH(140)    SITU(500)   | CURL(140)    PUSH(140)    SITU(500)   |
  |         | BIKE(30min)  BIKE(30min)  TUBE(500)   | BIKE(30min)  BIKE(30min)  TUBE(500)   |
  |         |                           NECK(500)   |                           NECK(500)   |
  -------------------------------------------------------------------------------------------
...
# DAY
  ```
     TIME   |  TASK | NOTES
  -------------------------------------------------------
  0400 0530 |  운동  | 4AM 블루콜리, 꿀, 아몬드, 커피, 보충
  0530 0630 |  예배  | 기도 30분
  0630 0800 |  개발  | 점심은 없다
  -------------------------------------------------------
  0800 0400 |  일과  | 4PM 블루콜리, 치킨쌀밥
  0400 0630 |  자유  |
  0630 0800 |  개발  | 취침은 8시에서 9시 사이, 기상은 무조건 4시
  ------------------------------------------------------- 
  ```
