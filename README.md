...
3. 아이디어
- 레버리지
   - 전망이 좋은 국가의 경제가 휘청해서 "시총/(GDP+중앙은행)" 버핏지수가 트렌드라인에 근접할때 레버리지 ETF 적극매수를 고려한다.
   - 위의 시나리오가 아니면 "망하는 건 순식간이다" 레버리지 ETF를 피한다.
- 소비계획
   - 자동차는 총자산의 5% 까지만 (사고 싶은 차의 20배가 있으면 그 차를 산다)
   - 집은 렌트로 살다가 가정을 이루고 정착하면 산다.
- 미래산업
