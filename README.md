# MOVE
  ...
  -------------------------------------------------------------------------------------------
  |  COOK   | PULL(50)     RDIP(50)     CALF(500)   | PULL(50)     RDIP(50)     CALF(500)   |
  |         | CURL(100)    PUSH(100)    SITU(500)   | CURL(100)    PUSH(100)    SITU(500)   |
...
# DAY
  ```
     TIME   |  TASK    | NOTES
  -------------------------------------------------------
  0400 0600 |  운동 2.0 | 4AM 블루콜리, 꿀, 아몬드, 커피, 보충
  0600 0700 |  예배 1.0 | 말씀30분 + 기도30분
  0700 0800 |  공부 1.0 | 독서/코딩/영어
  -------------------------------------------------------
  0800 0400 |  일과 8.0 | 4PM 블루콜리, 치킨쌀밥
  0400 0800 |  자유 4.0 | 취침은 8시에서 9시 사이, 기상은 무조건 4시
  ------------------------------------------------------- 
  ```
