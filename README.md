# TIME
  ```
     TIME     TASK
  ------------------------
  0430 0530  기상 운동       # 0500 블루케일 700ml + 블루케일
  0530 0600  예배           
  ------------------------
  0600 0800  훈련  (2.0H)   # 0900 물 700ml + 트리플-쌀밥 (쌀밥 & 치킨, 마늘, 아스파라거스)
  0800 1200  일과  (4.0H)   # 1200 물 700ml + 트리플-스크램블 (계란(2) & 두부, 양파, 후추)
  1200 0400  일과  (4.0H)   
  0400 0800  자유  (4.0H)   # 0500 블루케일 700ml + 트리플-타코 (콘쉘(3) & 해산물, 마늘, 사우어크라우트)
  ------------------------
  0800 0820  성경
  0820 0830  정리 취침
  ------------------------
...
# MOVE
  ...
  PULL(50)   DIPS(50)   SIT(200)  |  CURL(200)  PUSH(200)  SIT(200)  |  320
